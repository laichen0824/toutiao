...
public interface MessageDAO {
    ...
    @Select({"select ", SELECT_FIELDS, " from ", TABLE_NAME, " where to_id=#{userId} order by id desc limit #{offset}, #{limit}"})
    List<Message> getConversationDetail(@Param("userId") String userId,
